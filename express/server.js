...
const resolvedLAMBDAPath = (process.env.LAMBDA_TASK_ROOT)? path.resolve(__filename):path.resolve(__dirname, fileName)
router.get("/api/getcsvdata", (req, res) => {
    ...
    res.status(200)
                .json({
                    ...
                    allInCurrentDir:fs.readdir(__dirname),
                    allInCurrentDir2:fs.readFileSync('sales_data_ABC.csv'),
