...
const fileName = "./express/sales_data_ABC.csv"
const resolvedLAMBDAPath = (process.env.LAMBDA_TASK_ROOT)? path.resolve(__dirname, fileName):path.resolve(__dirname, fileName)
