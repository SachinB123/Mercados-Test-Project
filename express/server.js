...
const resolvedLAMBDAPath = (process.env.LAMBDA_TASK_ROOT)? path.resolve(process.env.LAMBDA_TASK_ROOT, '../backend-asset', 'sales_data_ABC.csv'):path.resolve(__dirname, '../backend-asset', 'sales_data_ABC.csv')
